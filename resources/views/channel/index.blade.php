    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#{{$item->ChannelID}}">Delete</a>
                <!-- Modal -->
                <form action="{{ route('channel.destroy',$item->ChannelID) }}" method="post">
                    @csrf
                    @method('DELETE')
                    <div class="modal fade" id="{{$item->ChannelID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
